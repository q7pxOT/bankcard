...
class UploadFile {
    ...
    private $config =   array(
        ...
        'allowTypes'        =>  array('image/jpg', 'image/gif', 'image/png', 'image/jpeg','image/jpeg','audio/mp3','audio/x-wav','application/vnd.ms-excel','application/octet-stream','text/csv'),    // 允许上传的文件类型 留空不做检查
